...
try:
    ...
    try:
        ...
        __import__('os').system(f'xdg-open https://wa.me/6289516701746?text=BANNER%20ERROR%20%3A%20{quote(str(e))}')
        exit()
    except(Exception, KeyboardInterrupt) as e:
        from urllib.parse import quote
        __import__('os').system(f'xdg-open https://wa.me/6289516701746?text=BANNER%20ERROR%20%3A%20{quote(str(e))}')
...
class Terminal:
  ...
  [white]| | /  /\  \\     }| {__ | {}  }\      /\      /| |\ \ 
  `-' `-'  `-' `---' `----'`----'  `----'  `----' `-' `-'                                                  
  [grey50]AUTHOR : [green]Badrulxd [grey50]|| VERSION : [green]1[grey50] || STATUS : [green] PRIBADI 
...
[white]| || |\  |.-._} } | | /  /\  \\  {_ }| .-. \/  /\  \| |\ /| |
`-'`-' `-'`----'  `-' `-'  `-' `---' `-' `-'`-'  `-'`-' ` `-'                                                   
  [grey50]AUTHOR : [green]Badrulxd [grey50]|| VERSION : [green]0.1[grey50] || STATUS : [green] PRIBADI 
